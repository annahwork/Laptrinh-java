(function () {
    ...
    // Hàm này sẽ chuyển hướng, kích hoạt LocaleChangeInterceptor của Spring
    ...
    // Hàm gán sự kiện cho dropdown ngôn ngữ
    function initializeLanguageSwitcher() {
        ...
        if (languageSelect) {
            ...
            console.error('Language select element (#language-select) not found in the DOM.');
        }
    }
