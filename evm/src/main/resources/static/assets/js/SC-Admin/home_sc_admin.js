(function () {
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        if (!mainContent) {
            ...
            console.error(T('error.main_content_not_found', 'Main content not found'));
        ...
        function loadPageScript(scriptName) {
            ...
            script.onerror = () => {
                ...
                console.warn(T('error.script_not_found', 'Script not found:'), finalScriptName);
            ...
            fetch(urlToFetch)
                ...
                .then(response => {
                    ...
                    if (!response.ok) {
                        ...
                        throw new Error(T('error.http_failed', `HTTP error! status: ${response.status}`));
                ...
                .catch(error => {
                    ...
                    const errorHint = T('error.check_path', 'Vui lòng kiểm tra đường dẫn file hoặc thử lại sau.');
